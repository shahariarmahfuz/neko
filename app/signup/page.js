...
export default function SignupPage() {
  ...
  const canSubmit = useMemo(() => {
    return name.trim() && email.includes("@") && password.length >= 4;
  }, [email, name, password]);
  ...
  return (
    <main style={{ fontFamily: "system-ui", padding: 24, maxWidth: 720, margin: "0 auto" }}>
      <header style={{ marginBottom: 24 }}>
        <h1 style={{ marginBottom: 8 }}>User Signup</h1>
        <p style={{ margin: 0, color: "#4b5563" }}>
          নতুন ইউজার অ্যাকাউন্ট তৈরি করুন এবং ড্যাশবোর্ডে যান।
        </p>
      </header>
      ...
      <footer style={{ marginTop: 16, color: "#4b5563" }}>
        আগেই অ্যাকাউন্ট আছে? <Link href="/login">Login</Link>
      </footer>
    </main>
  );
}
